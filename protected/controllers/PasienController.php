...
class PasienController extends Controller
{
	...
	public function loadModel($id)
	{
		...
		$namaWilayah = $model->wilayah->nama;

		$model->setAttribute('wilayah_id', $namaWilayah);
		return $model;
	}

	public function actionGrafikPasienWilayah()
	{
		$data = Pasien::model()->getCountPerWilayah();
		$this->render('grafik_pasien_wilayah', array('data' => $data));
	}
